...
{{< button href="https://codeberg.org/NitrousTracker/nitroustracker/releases" size="regular" >}}Downloads{{< /button >}}
{{< button relref="/manual/foreword/" size="regular" >}}Guide{{< /button >}}
{{< button href="https://codeberg.org/NitrousTracker/nitroustracker/issues" size="regular" >}}Issue tracker{{< /button >}}
{{< button href="https://codeberg.org/NitrousTracker/nitroustracker" size="regular" >}}Source code{{< /button >}}
